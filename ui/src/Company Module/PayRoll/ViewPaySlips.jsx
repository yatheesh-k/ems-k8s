...
const ViewPaySlips = () => {
  ...
  const getPaySLips = () => {
    axios
      .get(`http://192.168.1.163:8092/payslip/company/${id}`)
      .then((response) => {
  ...
  const getFilteredList = async (searchData, month, year) => {
    ...
    let filteredData = slip.filter((data) => {
      ...
      const matchesMonth =
        !month || monthName.toLowerCase() === month.toLowerCase();
      ...
      <div className="container-fluid p-0">
        ...
        <div className="row">
          ...
          <DeletePopup
            ...
            handleConfirm={(employeeId, id) =>
              handleConfirmDelete(employeeId, id) / console.log(id)
