                        ...
                        <div className="salary-details" style={{ borderLeft: "1px solid black", borderRight: "1px solid black" }} >
                            <div style={{ display: "flex", justifyContent: "space-between" }}>
                                <div style={{ flex: 1, borderRight: "none", borderBottom: "none" }}>
                                    <ul style={{ listStyleType: "none", padding: 0, marginBottom: "2px" }}>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            ...
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.employeeId}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                        ...
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            ...
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.accountNo}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>Total Days</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{payslipData.attendance?.totalWorkingDays || 0}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                ...
                                <div style={{ flex: 1, borderBottom: "none", overflow: "hidden" }}>
                                    <ul style={{ listStyleType: "none", padding: 0, marginBottom: "2px" }}>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>Name</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}> {employeeDetails.firstName} {employeeDetails.lastName}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>PAN</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.panNo}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>UAN</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.uanNo}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>IFSC</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.ifscCode}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>Worked Days</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{payslipData.attendance?.noOfWorkingDays || 0}</span>
                                        </li>
                                        <li style={{ display: "flex", padding: "4px 8px", alignItems: "center" }}>
                                            <span style={{ flex: 1, color: "black", paddingTop: "10px", paddingRight: "35%" }}><b>Date of Birth</b></span>
                                            <span style={{ flex: 1, color: "black", marginRight: "15px", paddingTop: "10px" }}>{employeeDetails.dateOfBirth}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
