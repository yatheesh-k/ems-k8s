...
const OfferLetterPreview = () => {
    ...
    useEffect(() => {
        if (previewData) {
            ...
            setFatherName(previewData.employeeFatherName || "Recipient's Father's Name");
            ...
            <div className='card' style={{ position: "relative", overflow: "hidden" }}>
                ...
                <div className='card-body' style={{ paddingLeft: "20px", paddingRight: "20px", position: "relative", zIndex: "2" }}>
                    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
                        ...
                        <p><strong>To,  {previewData?.employeeName}</strong></p>
                        <p><strong>S/o,D/o {previewData?.employeeFatherName}</strong></p>
                        <p><strong>{previewData?.employeeAddress}</strong></p>
                        {/* <p><strong>{isEditing ? <input type="text" value={cityStateZip} onChange={e => setCityStateZip(e.target.value)} /> : cityStateZip}</strong></p> */}
                        <p><strong>Contact Number: {previewData?.employeeContactNo}</strong></p>
                        <div style={{ margin: '40px 0' }}>
                            ...
                            <p>
                                On behalf of <strong>{companyName}</strong>, hereinafter referred to as ‘the Company’, we are pleased to extend an offer for the position of <strong>{previewData?.employeePosition}</strong> in our organization with the following mentioned details:
                            </p>
                                ...
                                .map(structure => (
                                    <React.Fragment key={structure.id}>
                                        {Object.entries(structure.allowances).map(([key, value]) => {
                                            ...
                                            return (
                                                <tr key={key}>
                                                    ...
                                                    <td>{Math.round(allowanceAmount.toFixed(2) / 12)}</td>
                                                    <td>{Math.round(allowanceAmount.toFixed(2))}</td>
                                                </tr>
                                            );
                                        })}
                                        <tr>
                                            ...
                                            <td>{Math.round(grossAmount - calculatedValues.totalAllowances)}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Gross (CTC)</strong></td>
                                            <td>{Math.round(grossAmount / 12)}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{calculatedValues.totalDeductions ? Math.round(calculatedValues.totalDeductions) : 0}</td>
                                        </tr>
                                        {/* <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{calculatedValues.netSalary ? Math.round(calculatedValues.netSalary) : 0}</td>
                                        </tr>
                                    </React.Fragment>
                                ))}
                        </tbody>
