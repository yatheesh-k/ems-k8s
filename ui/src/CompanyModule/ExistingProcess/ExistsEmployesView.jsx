...
const ExistsEmployeeView = () => {
  ...
  const getUser = () => {
    axios
      .get("http://192.168.1.163:8092/relieving/all")
      .then((response) => {
  ...
  const handleConfirmDelete = async (employeeId) => {
    if (selectedItemId) {
      try {
        await axios.delete(`http://192.168.1.163:8092/relieving/${employeeId}`);
        ...
        <div className="row d-flex align-items-center justify-content-between mt-1">
          <div className="col">
            <h1 className="h3 mb-3">
              <strong>Exists Employees Summary</strong>
            </h1>
          </div>
          <div className="col-auto">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item acitve">Exists Employee view</li>
              </ol>
            </nav>
          </div>
        </div>
...
export default ExistsEmployeeView;
