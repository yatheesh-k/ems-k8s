...
const CompanyRegistration = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            formData.append("CompanyCINNumber", data.CompanyCINNumber);

            // const response = await companyRegistationApi(formData, {
                                                    ...
                                                    <div>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={companyType === 'privateLimited'}
                                        ...
                                        <div className="card-body">
                                            <div className='row'>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    ...
                                                    />
                                                    {errors.companyCINNumber && <p className="errorMsg">{errors.companyCINNumber.message}</p>}
                                                </div>
                                                <div className='col-lg-1'></div>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company MailId <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="email"
                                                        className="form-control"
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Land Number <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="tel"
                                                        className="form-control"
                                                        ...
                                                        {...register("landNo", {
                                                            ...
                                                            pattern: {
                                                                value: /^[0-9]{10}$/,
                                                                message: "Land Number should contain only 10 numbers"
                                                            }
                                                        })}
                                                    />
                                                    {errors.landNo && <p className="errorMsg">{errors.landNo.message}</p>}
                                                </div>
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-2'>
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("mobileNo", {
                                                            ...
                                                            pattern: {
                                                                value: /^[0-9]{10}$/,
                                                                message: "Mobile Number should contain only 10 numbers"
                                                            }
                                                        })}
                                                    />
                                                    {errors.mobileNo && <p className="errorMsg">{errors.mobileNo.message}</p>}
                                                </div>

                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company Address <span style={{ color: "red" }}>*</span></label>
                                                    <textarea
                                                        type="text"
                                                        className="form-control"
                                ...
                                <div className="col-12">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <div className='row'>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company Register Number <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="text"
                                                        className="form-control"
                                                        ...
                                                        {...register("companyRegNo", {
                                                            ...
                                                            pattern: {
                                                                value: /^[0-9a-zA-Z]+$/,
                                                                message: "Company Register Number should contain only letters and numbers"
                                                            }
                                                        })}
                                                    />
                                                ...
                                                <div className='col-lg-1'></div>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company GST Number <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="text"
                                                        className="form-control"
                                                        ...
                                                        {...register("gstNo", {
                                                            ...
                                                            pattern: {
                                                                ...
                                                                message: "Company GST Number should be exactly 15 characters long and alphanumeric"
                                                            }
                                                        })}
                                                    />
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company Pan Number <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="text"
                                                        className="form-control"
                                                        ...
                                                        {...register("panNo", {
                                                            ...
                                                            pattern: {
                                                                ...
                                                                message: "Company Pan Number should be in the format: ABCDE1234F"
                                                            }
                                                        })}
                                                    />
                                                ...
                                                <div className='col-lg-1'></div>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Company Logo <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="file"
                                                        className="form-control"
                                                        {...register("file", {
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <div className='row'>
                                                ...
                                                <div className='col-lg-1'></div>
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Personal MailId <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="email"
                                                        className="form-control"
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Personal Mobile Number <span style={{ color: "red" }}>*</span></label>
                                                    <input
                                                        type="tel"
                                                        className="form-control"
                                                        placeholder="Enter Mobile Number"
                                                        ...
                                                        {...register("personalMobileNo", {
                                                            ...
                                                            pattern: {
                                                                value: /^[0-9]{10}$/,
                                                                message: "Mobile Number should be exactly 10 digits long and should contain only numbers"
                                                            }
                                                        })}
                                                    />
                                                    {errors.personalMobileNo && <p className="errorMsg">{errors.personalMobileNo.message}</p>}
                                                </div>
                                                ...
                                                <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    ...
                                                    <textarea
                                                        ...
                                                        {...register("address", {
                                                            ...
                                                            pattern: {
                                                                value: /^[0-9a-zA-Z\s]+$/,
                                                                message: "Address should contain only letters, numbers, and spaces"
                                                            }
                                                        })}
                                                    />
