    ...
    public ResponseEntity<?> createRelieving(RelievingRequest relievingRequest) {
        ...
        try {
            ...
            if (existingEmployeeId.isPresent()) {
                ...
                throw new NotFoundException(HttpStatus.NOT_ACCEPTABLE, "Employee with ID " + relievingRequest.getEmployeeId() + " already exists. Cannot add relieving for an existing employee.");
            }
