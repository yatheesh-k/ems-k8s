...
import com.pbt.ems.mappers.SalaryMapper;
import com.pbt.ems.repository.*;
import com.pbt.ems.request.SalaryRequest;
import com.pbt.ems.response.AllowanceResponse;
import com.pbt.ems.response.DeductionResponse;
    ...
    public ResponseEntity<?> addSalary(String employeeId, SalaryRequest salaryRequest) {
        try {
            ...
            if (salaryRepository.existsByEmployee(employee)) {
                ...
                throw new BaseException(HttpStatus.NOT_ACCEPTABLE,"Salary for the employee already exists");
            }
    ...
    public ResponseEntity<?> updateBySalaryId(String salaryId, SalaryRequest salaryRequest) {
        try {
            ...
            if (salaryOptional.isPresent()){
                ...
                throw new BaseException(HttpStatus.NOT_FOUND, "The Salary with " + salaryId + " not found");
            }
        } catch (BaseException ex) {
