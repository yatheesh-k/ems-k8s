...
import com.pbt.ems.response.ResultLoginResponse;
    ...
    public ResponseEntity<?> sendOtpToEmail(LoginRequest loginRequest) {
        try {
            ...
            if (employeeLogin != null) {
                ...
                throw new BaseException(HttpStatus.NOT_FOUND, "EmailId not found");
            }
            ...
            if (storedPassword == null) {
                ...
                throw new BaseException(HttpStatus.NOT_FOUND, "Password not found for emailId");
            }
            ...
            if (!loginRequest.getPassword().equals(storedPassword)) {
                ...
                throw new BaseException(HttpStatus.NOT_ACCEPTABLE, "Incorrect password for emailId: " + loginRequest.getEmailId());
            }
            ...
            throw new BaseException(HttpStatus.INTERNAL_SERVER_ERROR, "An error occurred during OTP sending to emailId: " + loginRequest.getEmailId());
        }
    }
    ...
    public ResponseEntity<?> loginAdmin(LoginRequest loginRequest) {
        try {
            ...
            if (employeeLogin != null) {
                ...
                throw new BaseException(HttpStatus.NOT_FOUND, "Email ID not found");
            }
            ...
            if (expiryTime == null || LocalDateTime.now().isAfter(expiryTime)) {
                ...
                throw new BaseException(HttpStatus.NOT_ACCEPTABLE, "OTP has expired");
            }
            ...
            if (loginEntity instanceof EmployeeLogin) {
                ...
                try {
                    ...
                    throw new BaseException(HttpStatus.INTERNAL_SERVER_ERROR, "Error reading company logo image");
                }
            } else if (loginEntity instanceof CompanyLogin) {
            ...
            throw new BaseException(HttpStatus.INTERNAL_SERVER_ERROR, "An error occurred during the login: " + ex);
        }
    }
