...
const EmpPaySlip = () => {
  ...
  const getView = (employeeId, id) => {
    const pdfImageUrl = `http://192.168.1.163:8092/payslip/image/${employeeId}/${id}`;
      ...
      cell: (row) => (
        <div>
          <button
            ...
            onClick={() => getView(row.employeeId, row.id)}
          >
                ...
                <div className="card flex-fill">
                  <div className="card-header">
                    <div className='row'>
                      ...
                      <div className='col-4 col-md-3 col-lg-12 mt-3'>
                        <select
                          className="form-select"
                          value={selectedMonth}
                          onChange={(e) => {
