...
const CompanyView = () => {
  ...
  const getUser = () => {
    axios.get("http://192.168.1.163:8092/company/all")
      .then((response) => {
  ...
  const handleConfirmDelete = async (companyId) => {
    if (selectedItemId) {
      try {
        ...
        await axios.delete(`http://192.168.1.163:8092/company/${companyId}`)
          .then((response) => {
  ...
  const columns = [
    ...
    {
      name: <h5 style={{ paddingLeft: "0px" }}><b>Company Id</b></h5>,
      selector: (row) => row.companyId,
      minWidth: "100px",
      maxWidth: "150px",
    },
    {
      name: <h5><b>Company Name</b></h5>,
    ...
    {
      name: <h5><b>EmailId</b></h5>,
      selector: (row) => row.emailId,
      width: "200px",
      wrap: true
    },
    {
      name: <h5><b>MobileNO</b></h5>,
    ...
    },
    {
      ...
      cell: (row) => <div> <button className="btn btn-sm " style={{ backgroundColor: "transparent", border: "none", padding: "0", marginRight: "10px" }} onClick={() => getData(row.companyId)} ><PencilSquare size={22} color='#2255A4' /></button>
        <button className="btn btn-sm " style={{ backgroundColor: "transparent", border: "none", padding: "0", marginLeft: "5px" }} onClick={() => handleShowDeleteModal(row.companyId)}><XSquareFill size={22} color='#DA542E' /></button>
      </div>
    }
  ]
       ...
       <Header/>
        <main className="content">
          <div className="container-fluid p-0">
            <h1 className="h3 mb-3"><strong>Company List</strong> </h1>
            <div className="row">
