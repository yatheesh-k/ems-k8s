...
const ManageAttendence = () => {
    ...
    const onSubmit = (data) => {
        ...
        axios.post(`http://192.168.1.163:8092/attendance/${employeeId}`, payload)
            .then((response) => {
            ...
            <div className='main'>
                ...
                <main className="content">
                    <div className="container-fluid p-0">
                        <h1 className="h3 mb-3"><strong>Attandance Management</strong> </h1>
                        <div className="row">
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className="card-body">
                                            <div className='row'>
                                                ...
                                                <div className='col-lg-1'></div> <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    ...
                                                    {errors && errors.numberOfWorkingDays && (
                                                        <p className="errorMsg">{errors && errors.numberOfWorkingDays.message}</p>
                                                    )}
                                                </div>
                                                ...
                                                <div className='col-lg-1'></div> <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setNumberOfLeaves(parseFloat(e.target.value))}
                                                    />
                                                    {errors && errors.numberOfWorkingDays && (
                                                        <p className="errorMsg">{errors && errors.numberOfWorkingDays.message}</p>
                                                    )}
                                                ...
                                                <div className='col-lg-1'></div> <div className='col-12 col-md-6 col-lg-5 mb-3'>
                                                    <label className="form-label">Number of Working Days</label>
                                                    <input
                                                        type="text"
                                                        className="form-control"
