...
const EmployeeReg = () => {
  ...
  const generateEmployeeId = (companyName) => {
    ...
    const newEmployeeId = companyName.toUpperCase().substring(0, 3) + formattedSeriesCounter;

    return newEmployeeId;
  };

  const getDepartment = () => {
    return axios.get(`http://192.168.1.163:8092/department/all`)
      .then((response) => {
  ...
  const getStatus = () => {
    axios.get(`http://192.168.1.163:8092/status/all`)
      .then((response) => {
        ...
        const filteredStatus = response.data.filter(role => statusesToInclude.includes(role.statusInfo));
          ...
          <div className="container-fluid p-0">
            ...
            <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/employeeview">Employee View</a></li>
                    <li class="breadcrumb-item acitve">Employee Registration</li>
                  </ol>
                </nav>
            </div>
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h5 className="card-title ">{isUpdating ? "Employee Data"  : 'Employee Registration'}</h5>
                  ...
                  <div className="card-body">
                    <form onSubmit={handleSubmit(onSubmit)} >
                      ...
                      <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter Last Name" name='employeeType'
                             readOnly 
                          ...
                          />
                          {errors.employeeType && (<p className='errorMsg'>{errors.employeeType.message}</p>)}
                        </div>
                        ):(
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type={isUpdating?"text":"text"} readOnly={isUpdating} className='form-control' placeholder="Enter Employee ID" name='employeeId' 
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter First Name" name='firstName'
                             onInput={toInputTitleCase} autoComplete='off' onKeyDown={handleEmailChange}
                           {...register("firstName", {
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type={isUpdating?"email":"email"} readOnly={isUpdating} className='form-control' placeholder="Enter Email" name='emailId'
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type={isUpdating?"date":"date"} readOnly={isUpdating} name='dateOfHiring' placeholder="Enter Hiring Date" className='form-control'
                          autoComplete='off'  max={threeMonthsFromNow} 
                            {...register("dateOfHiring", {
                              required: true,

                            })}
                          />
                          {errors.dateOfHiring && (<p className='errorMsg'>Date of Hiring Required</p>)}
                        </div>
                        <div className='col-lg-1'></div>
                        <div className='col-12 col-md-6 col-lg-5 mb-2' >
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-2' >
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              ...
                              {...field}
                              options={des}
                              value={des.find(option => option.value === field.value)} 
                              onChange={(val) => {
                                field.onChange(val.value); // Send only the value
                              }}
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter Manager"
                             onInput={toInputTitleCase} autoComplete='off' onKeyDown={handleEmailChange}
                            {...register("manager", {
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <div className='col-sm-12 input-group'>
                            <input className='form-control' placeholder="Enter Password"
                              onChange={handlePasswordChange} autoComplete='off' onKeyDown={handleEmailChange}
                            ...
                            />
                            <i onClick={togglePasswordVisiblity} style={{margin:"5px"}}> {passwordShown ? (
                              <Eye size={17} />
                            ) : (
                              <EyeSlash size={17} />
                            )}</i>
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter account Number" name='ipAddress'
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter ifsc code" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter bank name" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <textarea type="text" className='form-control' placeholder="Enter address" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter aadhar Number" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter uan number" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 col-md-6 col-lg-5 mb-3' >
                          ...
                          <input type="text" className='form-control' placeholder="Enter pan number" name='ipAddress'
                            onInput={toInputTitleCase} autoComplete='off'
                            {...register("ipAddress", {
                              required: "Ip Address Required",
                        ...
                        <div className='col-12 mt-4  d-flex justify-content-end' style={{background:"none"}} >
                          <button className={isUpdating ? "btn btn-danger bt-lg" : "btn btn-primary btn-lg"} style={{marginRight:"65px"}}  type='submit'>{isUpdating ? 'Update Employee' : 'Add Employee'} </button>
                        </div>
                      </div>
                    </form>
                  </div>
