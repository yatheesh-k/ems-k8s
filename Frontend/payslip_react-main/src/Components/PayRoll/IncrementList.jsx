...
//     {
//       name: 'Action',
//       selector: row =><><button>Edit</button> <button>Delete</button></>,
//     },
//   ];
...
//           <h1 className="h3 mb-3"><strong>Salary Increament List</strong> </h1>
...
const IncrementList = () => {
  ...
  const getMonthNames = () => {
    return Array.from({ length: 12 }, (_, i) => (i + 1).toLocaleString('en-US', { minimumIntegerDigits: 2 }));
  };
  ...
  const getUser = () => {
    axios.get("http://192.168.1.163:8092/payroll/all")
      .then((response) => {
  ...
  const statusMappings = {
    ...
    2: { label: <b style={{ backgroundColor: "red", color: "white", borderRadius: "5px", padding: "2px" }}>Relieved</b>, color: "orange" },
    3: { label: <b style={{ backgroundColor: "orange", color: "white", borderRadius: "5px", padding: "2px" }}>Notice Period</b>, color: "red" },
  ...
  const columns = [
    ...
    {
      name: <h5 style={{ paddingLeft: "0px" }}><b>Employee Id</b></h5>,
    ...
    { 
      name: <h5><b>Month/Year</b></h5>,
      selector: (row) => `${row.month} ${row.year}`,
      width: "120px",
      wrap: true
    },
    {
      name: <h5><b>Increment</b></h5>,
   ...
   
    {
      ...
      cell: (row) => <div> <button className="btn btn-sm " style={{ backgroundColor: "transparent", border: "none", padding: "0", marginRight: "10px" }} onClick={() => getData(row.employeeId)} ><PencilSquare size={22} color='#2255a4' /></button>
        <button className="btn btn-sm " style={{ backgroundColor: "transparent", border: "none", padding: "0", marginLeft: "5px" }} onClick={() => handleShowDeleteModal(row.employeeId)}><XSquareFill size={22} color='#da542e' /></button>
      </div>
  ...
  const filterByMonthYear = (selectedMonth, selectedYear) => {
    ...
    const result = view.filter((data) => {
      ...
      return (resignMonth === parseInt(selectedMonth) || !selectedMonth) &&
  ...
  return (
    <div className='wrapper'>
      ...
      <div className='main'>
        ...
        <main className="content">
          <div className="container-fluid p-0">
            <h1 className="h3 mb-3"><strong>Increment List</strong> </h1>
                    <div className="row">
                      <div className="col-12 col-lg-12 col-xxl-12 d-flex">
                        <div className="card flex-fill">
                          <div className="card-header">
                            ...
                            <div className='row'>
                              ...
                              <div className='col-12 col-md-6 col-lg-3 mt-3'>
                                <select
                                  className="form-select"
                                  value={selectedYear}
                                  onChange={(e) => filterByMonthYear(selectedMonth, e.target.value)}
                                >
                                  <option value="">Select Year</option>
                                  {getRecentYears().map((year) => (
                                    <option key={year} value={year}>{year}</option>
                              ...
                              <div className='col-12 col-md-6 col-lg-3 mt-3'>
                                <select
                                  className="form-select"
                                  value={selectedMonth}
                                  onChange={(e) => filterByMonthYear(e.target.value, selectedYear)}
                                >
                                  <option value="">Select Month</option>
                                  {getMonthNames().map((month, index) => (
