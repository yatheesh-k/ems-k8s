...
const Body = () => {
    ...
    useEffect(() => {
        axios.get('http://192.168.1.163:8092/dashboard/all')
            .then(response => {
                        ...
                        {loading ? (
                            ...
                            <div className="row">
                                <div className="col-xl-12 col-5">
                                    <div className="w-100">
                                    {data.map(item => (
                                        <div className="row" key={item.id} style={{justifyContent:"space-evenly"}}>
                                                <div  className="col-sm-4">
                                                    <div className="card">
                                                        <div className="card-body">
                                                            ...
                                                            <div className="mb-0">
                                                                <span className="text-muted">Last Updated {item.employeesDaysAgo} </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-sm-4">
                                            <div className="card">
                                                <div className="card-body">
                                                    ...
                                                    <div className="mb-0">
                                                        <span className="text-muted">Last Updated {item.daysAgo} </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
